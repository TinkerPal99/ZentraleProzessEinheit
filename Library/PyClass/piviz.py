...
class PiViz:
    def __init__(self, page):
        ...
        self.__News = PyViz.library.reference.CSVtoList(
            "library/csv/News.csv")  # ["Nachrichten", "nachrichten", "News", "news"]
        self.__Consent = PyViz.library.reference.CSVtoList(
            "library/csv/Consent.csv")  # ["Yes", "Jo", "Ja", "Yep", "Jep", "yes", "jo", "ja", "yep", "jep"]
        self.__Dissent = PyViz.library.reference.CSVtoList(
            "library/csv/Dissent.csv")  # ["No", "Nope", "Nep", "Noe", "no", "nope", "nep", "noe"]
    ...
    def onInput(self, strng=str):
        __recent_input = strng.lower()
...
assitent = PiViz(reference.Guardian)
print ( assitent.onInput(input("What can I do for you ?")) )
